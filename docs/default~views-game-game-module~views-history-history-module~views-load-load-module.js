(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~views-game-game-module~views-history-history-module~views-load-load-module"],{
...
class GameService {
    constructor() {
         ...
         */
        this.current_game = new rxjs__WEBPACK_IMPORTED_MODULE_1__["BehaviorSubject"](null);
        /*
        ...
        */
        let save_slots = localStorage.getItem('minesweeper_save_slots');
        let game_history = localStorage.getItem('minesweeper_game_history');
        // SAVE SLOTS
        if (!save_slots) {
            save_slots = [];
        ...
        if (!game_history) {
            ...
            game_history.map(game => {
                game.start_time = moment__WEBPACK_IMPORTED_MODULE_3__(game.start_time);
                game.end_time = moment__WEBPACK_IMPORTED_MODULE_3__(game.end_time);
            });
        }
        this.save_slots = new rxjs__WEBPACK_IMPORTED_MODULE_1__["BehaviorSubject"](save_slots);
        this.game_history = new rxjs__WEBPACK_IMPORTED_MODULE_1__["BehaviorSubject"](game_history);
     ...
     * @memberof GameService
     */
    start_game(width, heigth, difficulty) {
        let mines = [];
        const ratio = {
            'easy': 1 / 9,
            'medium': 1 / 6,
        ...
        this.current_game.next({
            ...
            difficulty,
            mines,
            start_time: moment__WEBPACK_IMPORTED_MODULE_3__(),
            end_time: null,
            total_time: null,
            flags: [],
            state: 'playing',
    ...
    save_game(save_slot, name) {
        this.current_game.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["take"])(1)).subscribe(game => {
            game.name = name;
            this.save_slots.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["take"])(1)).subscribe(save_slots => {
     ...
     */
    regtister_game(game) {
        game.end_time = moment__WEBPACK_IMPORTED_MODULE_3__();
        this.game_history.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["take"])(1)).subscribe(game_history => {
...
//# sourceMappingURL=default~views-game-game-module~views-history-history-module~views-load-load-module.js.map